...
INSERT INTO `MEDICAMENT` VALUES 
	...
	('DEPRIL9','DEPRAMIL','AIM','Clomipramine','Ce médicament est utilisé pour traiter les épisodes dépressifs sévères, certaines douleurs rebelles, les troubles obsessionnels compulsifs et certaines énurésies chez l\'\'enfant.','Ce médicament est contre-indiqué en cas de glaucome ou d\'\'adénome de la prostate, d\'\'infarctus récent, ou si vous avez reÃƒÂ Ã‚Â§u un traitement par IMAO durant les 2 semaines précédentes ou en cas d\'\'allergie aux atidépresseurs imipraminiques.',NULL),
	('DIMIRTAM6','DIMIRTAM','AAC','Mirtazapine','Ce médicament est utilisé pour traiter les épisodes dépressifs sévères.','La prise de ce produit est contre-indiquée en cas de d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants.',NULL),
	...
	('EVILR7','EVEILLOR','PSA','Adrafinil','Ce médicament est utilisé pour traiter les troubles de la vigilance et certains symptomes neurologiques chez le sujet agé.','Ce médicament est contre-indiqué en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants.',NULL),
	('INSXT5','INSECTIL','AH','Diphénydramine','Ce médicament est utilisé en application locale sur les piqÃƒÂ»res d\'\'insecte et l\'\'urticaire.','Ce médicament est contre-indiqué en cas d\'\'allergie aux antihistaminiques.',NULL),
	...
	('LIDOXY23','LIDOXYTRACINE','AFC','Oxytétracycline +LidocaÃƒÂ¯ne','Ce médicament est utilisé en injection intramusculaire pour traiter certaines infections spécifiques.','Ce médicament est contre-indiqué en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants. Il ne doit pas être associé aux rétinoÃƒÂ¯des.',NULL),
	('LITHOR12','LITHORINE','AP','Lithium','Ce médicament est indiqué dans la prévention des psychoses maniaco-dépressives ou pour traiter les états maniaques.','Ce médicament ne doit pas être utilisé si vous ÃƒÂªtes allergique au lithium. Avant de prendre ce traitement, signalez ÃƒÂ Ã‚Â  votre Médecin traitant si vous souffrez d\'\'insuffisance rénale, ou si vous avez un régime sans sel.',NULL),
	('PARMOL16','PARMOCODEINE','AA','Codéine + Paracétamol','Ce médicament est utilisé pour le traitement des douleurs lorsque des antalgiques simples ne sont pas assez efficaces.','Ce médicament est contre-indiqué en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants, chez l\'\'enfant de moins de 15 Kg, en cas d\'\'insuffisance hépatique ou respiratoire, d\'\'asthme, de phénylcétonurie et chez la femme qui allaite.',NULL),
	('PHYSOI8','PHYSICOR','PSA','Sulbutiamine','Ce médicament est utilisé pour traiter les baisses d\'\'activité physique ou psychique, souvent dans un contexte de dépression.','Ce médicament est contre-indiqué en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants.',NULL),
	('PIRIZ8','PIRIZAN','ABA','Pyrazinamide','Ce médicament est utilisé, en association à d\'\'autres antibiotiques, pour traiter la tuberculose.','Ce médicament est contre-indiqué en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants, d\'\'insuffisance rénale ou hépatique, d\'\'hyperuricémie ou de porphyrie.',NULL),
	...
	('TXISOL22','TOUXISOL Vitamine C','ALO','Tyrothricine + Acide ascorbique (Vitamine C)','Ce médicament est utilisé pour traiter les affections de la bouche et de la gorge.','Ce médicament est contre-indiqué en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants et chez l\'\'enfant de moins de 6 ans.',NULL),
	('URIEG6','URIREGUL','AUM','Fosfomycine trométamol','Ce médicament est utilisé pour traiter les infections urinaires simples chez la femme de moins de 65 ans.','La prise de ce médicament est contre-indiquée en cas d\'\'allergie ÃƒÂ Ã‚Â  l\'\'un des constituants et d\'\'insuffisance rénale.',NULL);
...
INSERT INTO `RAPPORT_VISITE` VALUES 
	('a131',3,23,'2013-04-20','Médecin curieux, à  recontacer en décembre pour réunion','Actualisation annuelle'),
	('a131',7,41,'2014-02-12','RAS\nChangement de tel : 05 89 89 89 89','Rapport Annuel'),
	('a17',4,4,'2014-03-01','Changement de direction, redéfinition de la politique médicamenteuse, recours au générique','Baisse activité');
...
INSERT INTO `VISITEUR` VALUES 
	...
	('a17','Andre','David','1 r Aimon de Chissée','38100','GRENOBLE','2008-06-19',NULL,'GY'),
	('a55','Bedos','Christian','1 r Bénédictins','65000','TARBES','2007-09-07',NULL,'GY'),
	('a93','Tusseau','Louis','22 r Renou','86000','POITIERS','2001-02-09',NULL,'SW'),
	('b13','Bentot','Pascal','11 av 6 Juin','67000','STRASBOURG','2003-11-06',NULL,'GY'),
	('b16','Bioret','Luc','1 r Linne','35000','RENNES','2003-01-06',NULL,'SW'),
	('b19','Bunisset','Francis','10 r Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23',NULL,'GY'),
	('b25','Bunisset','Denise','1 r Lionne','49100','ANGERS','2007-03-04',NULL,'SW'),
	('b28','Cacheux','Bernard','114 r Authie','34000','MONTPELLIER','2008-02-10',NULL,'GY'),
	('b34','Cadic','Eric','123 r Caponière','41000','BLOIS','2012-06-03','P','SW'),
	('b4','Charoze','Catherine','100 pl Géants','33000','BORDEAUX','2009-05-07',NULL,'SW'),
	('b50','Clepkens','Christophe','12 r Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18',NULL,'SW'),
	('b59','Cottin','Vincenne','36 sq Capucins','5000','GAP','2010-12-19',NULL,'GY'),
	('c14','Daburon','François','13 r Champs Elysées','6000','NICE','2012-01-20','S','SW'),
	('c3','De','Philippe','13 r Charles Peguy','10000','TROYES','2005-05-29',NULL,'SW'),
	('c54','Debelle','Michel','181 r Caponière','88000','EPINAL','2004-09-19',NULL,'SW'),
	('d13','Debelle','Jeanne','134 r Stalingrad','44000','NANTES','2012-05-25',NULL,'SW'),
	('d51','Debroise','Michel','2 av 6 Juin','70000','VESOUL','2011-08-17','E','GY'),
	('e22','Desmarquest','Nathalie','14 r Fédérico Garcia Lorca','54000','NANCY','2013-04-18',NULL,'GY'),
	('e24','Desnost','Pierre','16 r Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW'),
	('e39','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18',NULL,'GY'),
	('e49','Duncombe','Claude','19 av Alsace Lorraine','9000','FOIX','2012-09-16',NULL,'GY'),
	('e5','Enault-Pascreau','Céline','25B r Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY'),
	('e52','Eynde','Valérie','3 r Henri Moissan','76000','ROUEN','2012-09-16',NULL,'GY'),
	('f21','Finck','Jacques','rte Montreuil Bellay','74000','ANNECY','2012-09-16',NULL,'SW'),
	('f39','Frémont','Fernande','4 r Jean Giono','69000','LYON','2005-05-29',NULL,'GY'),
	('f4','Gest','Alain','30 r Authie','46000','FIGEAC','2005-05-29',NULL,'GY'),
	('g19','Gheysen','Galassus','32 bd Mar Foch','75000','PARIS','2005-05-29',NULL,'SW'),
	('g30','Girard','Yvon','31 av 6 Juin','80000','AMIENS','2012-05-25','N','GY'),
	('g53','Gombert','Luc','32 r Emile Gueymard','56000','VANNES','2012-05-25',NULL,'GY'),
	('g7','Guindon','Caroline','40 r Mar Montgomery','87000','LIMOGES','2012-05-25',NULL,'GY'),
	('h13','Guindon','François','44 r Picotière','19000','TULLE','2012-05-25',NULL,'SW'),
	('h30','Igigabel','Guy','33 gal Arlequin','94000','CRETEIL','2008-06-19',NULL,'SW'),
	('h35','Jourdren','Pierre','34 av Jean Perrot','15000','AURRILLAC','2008-06-19',NULL,'GY'),
	('h40','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19',NULL,'GY'),
	('j45','LABORATOIREuré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW'),
	('j50','Landré','Philippe','4 av Gén Laperrine','59000','LILLE','2000-05-01',NULL,'GY'),
	('j8','Langeard','Hugues','39 av Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY'),
	('k4','Lanne','Bernard','4 r Bayeux','30000','NIMES','2000-05-01',NULL,'SW'),
	('k53','Le','Noël','4 av Beauvert','68000','MULHOUSE','2000-05-01',NULL,'SW'),
	('l14','Le','Jean','39 r Raspail','53000','LAVAL','2000-05-01',NULL,'SW'),
	('l23','Leclercq','Servane','11 r Quinconce','18000','BOURGES','1998-11-23',NULL,'SW'),
	('l46','Lecornu','Jean-Bernard','4 bd Mar Foch','72000','LA FERTE BERNARD','1998-11-23',NULL,'GY'),
	('l56','Lecornu','Ludovic','4 r Abel Servien','25000','BESANCON','1998-11-23',NULL,'SW'),
	('m35','Lejard','Agnès','4 r Anthoard','82000','MONTAUBAN','1998-11-23',NULL,'SW'),
	('m45','Lesaulnier','Pascal','47 r Thiers','57000','METZ','1998-11-23',NULL,'SW'),
	('n42','Letessier','Stéphane','5 chem Capuche','27000','EVREUX','1998-11-23',NULL,'GY'),
	('n58','Loirat','Didier','Les PÃƒÂªchers cité Bourg la Croix','45000','ORLEANS','1998-11-23',NULL,'GY'),
	('n59','Maffezzoli','Thibaud','5 r Chateaubriand','2000','LAON','2005-12-21',NULL,'SW'),
	('o26','Mancini','Anne','5 r D\'\'Agier','48000','MENDE','2005-12-21',NULL,'GY'),
	('p32','Marcouiller','Gérard','7 pl St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21',NULL,'GY'),
	('p40','Michel','Jean-Claude','5 r Gabriel Péri','61000','FLERS','2005-12-21','O','SW'),
	('p41','Montecot','Françoise','6 r Paul Valéry','17000','SAINTES','2005-12-21',NULL,'GY'),
	('p42','Notini','Veronique','5 r Lieut Chabal','60000','BEAUVAIS','2005-12-21',NULL,'SW'),
	('p49','Onfroy','Den','5 r Sidonie Jacolin','37000','TOURS','2005-12-21',NULL,'GY'),
	('p6','Pascreau','Charles','57 bd Mar Foch','64000','PAU','1997-03-30',NULL,'SW'),
	('p7','Pernot','Claude-NoÃƒÂ«l','6 r Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02',NULL,'SW'),
	('p8','Perrier','MaÃƒÂ®tre','6 r Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23',NULL,'GY'),
	('q17','Petit','Jean-Louis','7 r Ernest Renan','50000','SAINT LO','2009-06-07',NULL,'GY'),
	('r24','Piquery','Patrick','9 r Vaucelles','14000','CAEN','2007-04-29','O','GY'),
	('r58','Quiquandon','JoÃƒÂ«l','7 r Ernest Renan','29000','QUIMPER','2006-09-30',NULL,'GY'),
	('s10','Retailleau','Josselin','88Bis r Saumuroise','39000','DOLE','2011-12-05',NULL,'SW'),
	('s21','Retailleau','Pascal','32 bd Ayrault','23000','MONTLUCON','2009-05-09',NULL,'SW'),
	('t43','Souron','Maryse','7B r Gay Lussac','21000','DIJON','2003-09-03',NULL,'SW'),
